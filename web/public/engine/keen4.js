...
async function KeenModule4(moduleArg = {}) {
  var moduleRtn;
...
// include: /var/folders/tg/b7lvg6ss55s_7f36rcx04tlc0000gn/T/tmp1q3jwhlu.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'web/public/engine/keen4.data';
      var REMOTE_PACKAGE_BASE = 'keen4.data';
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_web/public/engine/keen4.data');
      }
      Module['addRunDependency']('datafile_web/public/engine/keen4.data');
    ...
    loadPackage({"files": [{"filename": "/AUDIO.CK4", "start": 0, "end": 33325}, {"filename": "/AUDIODICT.CK4", "start": 33325, "end": 34349}, {"filename": "/AUDIOHEAD.CK4", "start": 34349, "end": 35001}, {"filename": "/EGADICT.CK4", "start": 35001, "end": 36025}, {"filename": "/EGAGRAPH.CK4", "start": 36025, "end": 556606}, {"filename": "/EGAHEAD.CK4", "start": 556606, "end": 570862}, {"filename": "/GAMEMAPS.CK4", "start": 570862, "end": 669902}, {"filename": "/MAPHEAD.CK4", "start": 669902, "end": 693308}], "remote_package_size": 693308});

  })();

// end include: /var/folders/tg/b7lvg6ss55s_7f36rcx04tlc0000gn/T/tmp1q3jwhlu.js
...
function findWasmBinary() {
  ...
  if (Module['locateFile']) {
    return locateFile('keen4.wasm');
  }

  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('keen4.wasm', import.meta.url).href;
...
var ASM_CONSTS = {
  33584: () => { if (typeof FS !== 'undefined' && FS.syncfs) FS.syncfs(false, function (err) { if (err) console.warn('[keen] persist failed:', err); }); }
};
