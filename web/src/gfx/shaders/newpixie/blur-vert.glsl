/*
   newpixie CRT — pass 3/4: 9-tap vertical Gaussian blur
   ...
   crt/shaders/newpixie/blur_vert.slang into the single-file libretro GLSL
   form the runtime loads. Same porting notes as blur-horiz.glsl.
*/
...
uniform COMPAT_PRECISION float blur_y;
#else
#define blur_y 1.0
#endif
...
void main()
{
    vec2 blur = vec2(0.0, blur_y) / OutputSize.xy;
